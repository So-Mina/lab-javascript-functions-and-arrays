...
function sumNumbers(arrayOfNumbers) {
 ...
 // Iteration #3.1 Bonus:
 function sum(someValues) {
   let sum = 0
   
   if (!someValues.length) {
     return 0
   } 
...
function averageNumbers(arrOfNumbers) {
  ...
  for (let i = 0 ; i < arrOfNumbers.length ; i++) {
    sumtotal += arrOfNumbers[i]
  }

  const avrg = sumtotal / arrOfNumbers.length
